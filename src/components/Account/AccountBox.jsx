  ...
  return (
    <View style={[styles.container]}>
      <TouchableOpacity style={[theme.bg1, styles.account_box]} onPress={()=>{setVisible(!visible)}}>
        ...
        <TouchableOpacity style={styles.arrow} onPress={()=>navigation.navigate("Account", {id: data.id, name: data.name})}><Image source={RightArrow} style={{height: 20, width: 20}}/></TouchableOpacity>
      </TouchableOpacity>
      {
        visible &&
